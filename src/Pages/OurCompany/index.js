...
class index extends Component {
    render() {
        return (
            <div className="container-fluid bgcompany">
                <div className='row justify-content-center'>
                    <h1 className='ourcompanystyle'><u>Our Company</u></h1>
                </div>
                <div className='row textheader'>
                    ...
                    <p className='textbody mt-3'>
                        ...
                        October 3, 1990, the Company's shares were offered to the public and listed in the PSE.
                        <br></br>
                        
                        On December 10, 1993, the Company changed its primary purpose to that 
                    ...
                    <p className='mt-5'><b>Description of Business</b></p>
                        <p className='mt-3'> 
                           The Company is a mining company engaged in exploring, developing,
                             ...
                             and the prospectivity of its projects. The Company’s vision is to become a leading 
                    ...
                    <p className='mt-3'>
                            ...
                            on August 4, 2015. As consideration for said termination, Geogen shall issue
                            NiHAO preferred shares that embodies a cumulative dividend computed annually
